...
function putDataOnLocalStorage() {
...
form.addEventListener("input", (0, _lodashThrottleDefault.default)(catchTextForm, 1000));
autoFillingEmail();
autoFillingMessage();
function autoFillingEmail() {
    if (oldText && oldText.email) email.value = oldText.email;
}
function autoFillingMessage() {
    if (oldText && oldText.message) message.value = oldText.message;
}
